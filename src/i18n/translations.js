export const translations = {
  es: {
    ...
    "services.ai": "IA y Machine Learning",
    ...
    "contact.emailPlaceholder": "tuemail@dominio.com",
    "contact.messagePlaceholder": "¿En qué te puedo ayudar?",
    ...
    "certifications.sub": "Certificaciones",
    "certifications.title": "Logros.",
    "certifications.view": "Ver credencial",

    "languages.sub": "Idiomas",
    ...
    "alt.logo": "Logo",
    "alt.menu": "Menú",
    "alt.webDevelopment": "Desarrollo web",
    ...
    "projects.login.name": "Login React + TypeScript",
    "projects.login.description": "Plantilla web desarrollada con React y TypeScript que proporciona una base sólida para sistemas de autenticación. Incluye formularios de inicio de sesión y registro con validación avanzada, componentes reutilizables y una arquitectura modular lista para integrarse con cualquier backend, facilitando el desarrollo rápido de interfaces modernas y escalables.",
    ...
    "certifications.cybersecurity.date": "2024",
    
    "certifications.security.name": "Seguridad y Privacidad de la Información",
    "certifications.security.issuer": "MinTIC",
    "certifications.security.date": "2024",
  ...
  en: {
    ...
    "contact.emailPlaceholder": "you@domain.com",
    ...
    "certifications.title": "Achievements.",
    ...
    "alt.logo": "Logo",
    "alt.menu": "Menu",
    "alt.webDevelopment": "Web development",
    ...
    "projects.login.name": "Login React + TypeScript",
    "projects.login.description": "Web template developed with React and TypeScript that provides a solid foundation for authentication systems. It includes login and registration forms with advanced validation, reusable components, and a modular architecture ready to integrate with any backend, facilitating rapid development of modern and scalable interfaces.",
    ...
    "certifications.security.name": "Information Security and Privacy",
    "certifications.security.issuer": "MinTIC",
    "certifications.security.date": "2024",
